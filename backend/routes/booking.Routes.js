...
router.route('/updatebooking/user').post(isAuthenticated,updateBooking)
router.route('/updatebooking/merchant/:id').post(isMerchant,updateBooking)
router.route('/updatebooking/admin').post(isAdmin,updateBooking)
